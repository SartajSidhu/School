   ...
   */
   ...
   public Time(String militaryTime)
   {
      ...
      else
      {
         ...
         Character.isDigit(militaryTime.charAt(0))==false)
         {
            System.out.println(militaryTime +
                               " is not a " +
                               "valid miliary time." );
         ...
         Character.isDigit(militaryTime.charAt(1))==false)
         {
            System.out.println(militaryTime +
                               " is not a " +
                               "valid miliary time." );
         ...
         Character.isDigit(militaryTime.charAt(3))==false)
         {
            System.out.println(militaryTime +
                               " is not a " +
                               "valid miliary time." );
         ...
         Character.isDigit(militaryTime.charAt(4))==false)
         {
            System.out.println(militaryTime +
                               " is not a " +
                               "valid miliary time." );
