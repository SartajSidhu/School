...
public class PizzaOrder
{
   public static void main (String[] args)
   {
      ...
      if(inches==10){
         ...
         System.out.print("Sorry that was not one of the size choices, so a 12 inch pizza will be made!\n");
         inches=12;
         cost=12.99;
      }
      ...
      switch (crustType) {
         ...
         case 'T': crustType='T';
                  break;
         default: System.out.print("That was not one of the choices, so a Hand-tossed crust will be made!\n"); 
                  crustType='H';
                  break; 
      }
      ...
      if(discount==true){
         System.out.println("Congratulations you have earned a discount of $2");
         cost-=2;
      }
